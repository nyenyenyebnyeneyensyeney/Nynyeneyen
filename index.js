...
async function starts() {
	...
	var opengc = `「 *Group Opened* 」\n\n${a}Group Telah Dibuka Oleh Admin${a}\n_Sekarang Semua Member Bisa Mengirim Pesan_`
    ...
    teks = `「 *Group Setting Change* 」\n\n${a}Edit Group info telah ditutup untuk member${a}\nSekarang hanya admin group yang dapat mengedit info Group Ini`
...
┗━━━━━━┈┈`
Vid.sendMessage(from, initod, text,{ quoted: ${fake}})
break
			}
			switch(command) {
...
┃◪ *${gru} Only Admin Group*
┗━━━━━━┈┈`
Vid.sendMessage(from, shu, text,{ quoted: ${fake}})
break
//============================ TICTACTOE MENU ==============================//
              case 'tictactoe': 
                case 'ttt': 
