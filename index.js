...
Thanks To @${dika.split('@')[0]}
Thanks To @${vanz.split('@')[0]}
Dan Terima Kasih Untuk Mark @${mark.split('@')[0]}
Karna Kgk Pernah Nge Banned Gwa
Github : _*https://github.com/dreamteam14*_
┏━━⬣_「 *YTEAM BOT* 」_
┃▢
┃▢ Status: ${statuss} MODE
┃▢ Prefix : ${prefix}
...
┗━━━━━━┈┈`
 Vid.sendMessage(from, initod, text, {quoted: freply, contextInfo: {'mentionedJid': [gw, mark, vanz, dika]}})
  break
			}
			switch(command) {
...
┃◪ *${gru} Only Admin Group*
┗━━━━━━┈┈`
 Vid.sendMessage(from, shu, text, {quoted: freply, contextInfo: {'mentionedJid': [gw, mark, vanz, dika]}})
  break
//============================ TICTACTOE MENU ==============================//
              case 'tictactoe': 
                case 'ttt': 
