...
lim = '⛱️'
gru = '◾'
ownerList: ["6285865829368@s.whatsapp.net"]
fake = 'Cucu Bot\nANTI DELETE'
...
Silah Kan Ketik *!Rules* Sebelum Menggunakan bot`
				...
				Vid.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, quoted:reply})
...
const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": `Cucu Bot\nCreate By : mek Team`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync(`media/Vid.jpeg`)} } }
...
if (isTicTacToe(from, tictactoe)) tictac(budy, prefix, tictactoe, from, sender, reply, mentions)        
           ...
           const statuss = public ? 'PUBLIC': 'SELF'
                reply('Loading Menu CucuBot')
shu = `
_*Create By*_ :  @${ownerList[0].split('@')[0]}
_*Github*_ : https://github.com/mekteam14
...
┃▢ Prefix : ${prefix}
┃▢ Browser : Chrome
┃▢ Version Wa : ${david.user.phone.wa_version}
┗━━━━━━┈┈
...
┏━━⬣*_TICTACTOE MENU_*
┃▢ ${prem} ${f}${prefix}tictactoe @user${f}
┃▢ ${prem} ${f}${prefix}ttc @user${f}
┃▢ ${prem} ${f}${prefix}delttc${f}
┃▢ ${prem} ${f}${prefix}delttt${f}
┗━━━━━━┈┈

┏━━⬣*_SESSION MENU_*
┃▢ ${prem} ${f}${prefix}jadibot${f}
┃▢ ${prem} ${f}${prefix}stopjadibot${f}
┃▢ ${prem} ${f}${prefix}listbot${f}
┗━━━━━━┈┈
...
Vid.sendMessage(from, shu, text,{ quoted: freply})
break
//============================ TICTACTOE MENU ==============================//
                case 'tictactoe': 
                case 'ttt': 
...
//============================ GROUP MENU ================================//
            case 'antilink':
				...
				if (mek.message.extendedTextMessage != undefined){
					...
					Vid.sendMessage(from, thumb,image,{quoted : troli})
				   }
				   break
				   case 'hidetag':
				 ...
				 Vid.sendMessage(from, options, text,{quoted :troli})
					break
//================================ JADIBOT ===============================// 
              case 'jadibot':
               Vid.on('qr', async qr => {
               var scan = await Vid.sendMessage(from, qr, image, {quoted:mek, caption:'Scan QR ini untuk jadi bot sementara\n\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk WhatsApp Web\n3. Scan QR ini \nQR Expired dalam 20 detik'})
                setTimeout(() => {
                Vid.deleteMessage(m.chat, scan.key)
                 }, 30000)
                 })
                 Vid.on('connecting', user => {
